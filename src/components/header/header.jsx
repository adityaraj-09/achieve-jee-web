            ...
            <nav class="navbar navbar-default">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/" itemscope itemtype="http://schema.org/Organization" itemprop="url"><img
                    src="images/allen-dlp-logo.png" alt="ALLEN Distance Learning Programe"/> </a>
              </div>
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" data-hover="dropdown"
                ...
                <ul class="nav navbar-nav navbar-right" id="desktop-menu-top">
                  ...
                  <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                      aria-haspopup="true" aria-expanded="false">DLP Courses <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu dropdown-menu-main">
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false">JEE (Main+Advanced) <img
                            src="images/new.gif" width="22" height="9"/><i class="fa fa-angle-down icon-l"></i></a>
                        <ul class="dropdown-menu-level-2">
                          <li> <a href="/study-material/study-material-jee-main-advanced.asp" class="p-0 m-0">Study
                              Material <br></br>
                              <small class="text-danger m-0">[Target 2024/2025]</small> </a></li>
                          <li><a href="/testseries/testseries-jee-main-advanced.asp">Test Series (CBT + PEN PAPER) <br></br>
                              <small class="text-danger">[Target 2024/2025]</small> </a></li>
                          <li><a href="/cbt/cbt-jee-advanced.asp">Computer Based Test (CBT) <br></br>
                              <small class="text-danger">[Target 2024/2025]</small> </a></li>
                          <li><a href="/joint-package/joint-package-jee-main-advanced.asp">Joint Package (SMP + TS) <br></br>
                              <small class="text-danger">[Target 2024/2025]</small> </a></li>
                        </ul>
                      </li>
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false">JEE (Main) <img src="images/new.gif"
                            width="22" height="9"/><i class="fa fa-angle-down icon-l"></i></a>
                        <ul class="dropdown-menu-level-2">
                      ...
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false">NEET(UG) <img src="images/new.gif"
                            width="22" height="9"/><i class="fa fa-angle-down icon-l"></i> </a>
                        <ul class="dropdown-menu-level-2">
                          ...
                          <li><a href="/testseries/testseries-package-premedical.asp">Test Series <br></br>
                              <small class="text-danger m-0">[Target 2024/2025]</small> </a></li>
                          <li><a href="/joint-package/joint-package-premedical.asp">Joint Package (SMP + TS) <br></br>
                              <small class="text-danger m-0">[Target 2024/2025]</small></a></li>
                        </ul>
                      </li>
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false">Class VI to X <img
                            src="images/new.gif" width="22" height="9"/> <i class="fa fa-angle-down icon-l"></i></a>
                        <ul class="dropdown-menu-level-2">
                          <li><a href="/study-material/study-material-class6.asp">SMP Class VI (CBSE & OLYMPIAD) <br></br>
                              <small class="text-danger m-0">[Target 2024]</small> </a></li>
                          <li><a href="/study-material/study-material-class7.asp">SMP Class VII (CBSE & OLYMPIAD)<br></br>
                              <small class="text-danger m-0">[Target 2024]</small> </a></li>
                          <li><a href="/study-material/study-material-class8.asp">SMP Class VIII (CBSE & OLYMPIAD) <br></br>
                              <small class="text-danger m-0">[Target 2024]</small> </a></li>
                          <li><a href="/study-material/study-material-class9.asp">SMP Class IX (CBSE & OLYMPIAD) <br></br>
                              <small class="text-danger m-0">[Target 2024]</small> </a></li>
                          <li><a href="/study-material/study-material-class10.asp">SMP Class X (CBSE & OLYMPIAD) <br></br>
                              <small class="text-danger m-0">[Target 2024]</small> </a></li>
                        </ul>
                      </li>
                      ...
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false">Olympiads <img src="images/new.gif"
                            width="22" height="9"/><i class="fa fa-angle-down icon-l"></i></a>
                        <ul class="dropdown-menu-level-2">
                          <li><a href="/olympiads/SMP-for-Science&Maths-Olympiads-Class-vi.asp">SMP for Science & Maths
                              Olympiads Class VI </a></li>
                          <li><a href="/olympiads/SMP-for-Science&Maths-Olympiads-Class-vii.asp">SMP for Science & Maths
                              Olympiads Class VII </a></li>
                          <li><a href="/olympiads/SMP-for-Science&Maths-Olympiads-Class-viii.asp">SMP for Science &
                              Maths Olympiads Class VIII </a></li>
                          <li><a href="/olympiads/SMP-for-Science&Maths-Olympiads-Class-ix.asp">SMP for Science & Maths
                              Olympiads Class IX </a></li>
                          <li><a href="/olympiads/SMP-for-Science&Maths-Olympiads-Class-x.asp">SMP for Science & Maths
                              Olympiads Class X </a></li>
                        </ul>
                      </li>
                  ...
                  <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                      aria-haspopup="true" aria-expanded="false">Scholarship <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu dropdown-menu-main">
                      <li><a
                          href="https://allenwebsite-general.s3.ap-south-1.amazonaws.com/dlp-website/pdf/2023-24/DLP-Scholarship-Criteria.pdf"
                          target="_blank">Scholarship for DLP </a></li>

                      <li><a href="/pdf/online-registration-process-for-scholarship.pdf" target="_blank">How to Apply
                          for Scholarship</a></li>
                      <li><a href="https://dlp.allen.ac.in/common/login-offline-online-2023-24.asp">Claim Scholarship
                          2023-24</a></li>

                    </ul>
                  </li>
                  <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                      aria-haspopup="true" aria-expanded="false">General Information <i
                    ...
                    <ul class="dropdown-menu dropdown-menu-main">
                      ...
                      <li><a href="/about-dsat.asp">About D-SAT</a> </li>
                    </ul>
                  </li>
                  <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                      aria-haspopup="true" aria-expanded="false">Student Zone <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu dropdown-menu-main  dropdownhover-bottom">
                      ...
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false"> FAQ's <img src="images/new.gif"
                            width="22" height="9"/><i class="fa fa-angle-down icon-l"></i></a>
                        <ul class="dropdown-menu-level-2 dropdownhover-bottom">
                          ...
                          <li><a href="/2022-23/mts-faq.asp" target="_blank">MTS FAQ </a> </li>
                        </ul>
                      </li>
                  ...
                  <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                      aria-haspopup="true" aria-expanded="false">All India Test Centers <i
                        class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu dropdown-menu-main">
                      ...
                      <li><a
                          ...
                          target="_blank">CBT Center Cities (2023-24) </a></li>


                    </ul>
                  </li>
                  <li class="dropdown"><a href="/" class="dropdown-toggle" data-toggle="dropdown" role="button"
                      aria-haspopup="true" aria-expanded="false">Online Courses <i class="fa fa-angle-down"></i> </a>
                    <ul class="dropdown-menu dropdown-menu-main">
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false">JEE (Main+Advanced) <i
                      ...
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false">JEE (Main) <i
                            class="fa fa-angle-down icon-l"></i></a>
                        <ul class="dropdown-menu-level-2">
                          <li><a
                      ...
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false">NEET(UG) <i
                            class="fa fa-angle-down icon-l"></i> </a>
                        <ul class="dropdown-menu-level-2">
                          <li><a
                      ...
                      <li class="dropdown-level-2"><a href="#" class="dropdown-toggle-1" data-toggle="dropdown"
                          role="button" aria-haspopup="true" aria-expanded="false">Class VI to X <i
                            class="fa fa-angle-down icon-l"></i></a>
                        <ul class="dropdown-menu-level-2">
                          <li><a
